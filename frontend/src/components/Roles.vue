...
<template>
    <div class="container">
        <div class="card-body text-center" style="margin-top: 50px">
            ...
            <p class="card-text">
                Estos son los roles que puede tener un usuario del laboratorio. Posibles roles
                pueden ser alumno, docente, ayudante, practicante, etc.
            </p>
        </div>
            ...
            <table class="table table-bordered-outline text-center">
                ...
                <tbody v-if="roles.getRols.length != 0" v-for="rol in roles.getRols">
                    <tr id="{{rol.id}}">
                        ...
                        <td>
                            <a class="btn btn-danger btn-space" @click="() => select_rol(rol.id)"
                ...
                <div v-if="showModalNuevo" class="modal-mask">
                    <div class="modal-container border rounded-3">
                        ...
                        <p class="text-center text-danger" v-if="errorBadRequest">
                            El rol proporcionado ya existe o esta en blanco
                        </p>
        ...
        <Teleport to="body">
            <Transition name="modal">
                <div v-if="showModal" class="modal-mask">
                    <div class="modal-container border rounded-3">
                        <div class="modal-header justify-content-center mb-3">Eliminar rol?</div>
